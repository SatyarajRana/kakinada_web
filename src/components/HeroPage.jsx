    ...
    <>
      <div>
        <div className="hero_container">
          <h1>
            Kakinada's Local shops <br />
            are now Online
          </h1>
          <Link to="/contact">
            <button>Start selling on Kakinada Super</button>
          </Link>
        </div>
        <div id="shop" className="hero_sec_container">
          <div className="hero_left">
            ...
            <p>
              eSamudaay Kakinada is the new digital address of your local kirana
              and favourite food joints! Shop for daily essentials, tasty food
              and much more from the convenience of your home. Have the peace of
              mind of knowing your deliveries are coming from the same local
              places you have known for years.
            </p>
